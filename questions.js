...
const QUESTION_POOL_MATERIAL_EXTENSION = {
  ...
  "windows-server-admin": [
    ...
    mc("srv-063", "hyper-v", "fortgeschritten", "Welche Hyper-V-Switch-Art erlaubt Kommunikation zwischen VMs untereinander, aber weder mit dem Host noch mit dem externen Netzwerk?", ["Privat", "Intern", "Extern", "Geteilt"], 0, "Ein privater virtueller Switch isoliert die VMs vom Host und vom physischen Netzwerk."),
