...
const QUESTION_POOL_SERVER_HYPERV_EXTENSION = {
  "windows-server-admin": [
    ...
    matchQuestion("srv-hv-007", "hyper-v-migration", "fortgeschritten", "Ordne den Migrationsverfahren ihren jeweiligen Zweck zu.", [
      { left: "Live Migration", right: "Verschiebt eine laufende VM zwischen Hosts ohne geplante Anwendungsunterbrechung." },
    ...
    mc("srv-hv-029", "hyper-v-import", "fortgeschritten", "Eine exportierte VM soll als zweite, unabhängige Test-VM auf demselben Host importiert werden. Welcher Importmodus vermeidet einen Konflikt der VM-Identität?", ["Copy", "Register in place", "Restore mit unveränderter VM-ID", "Quick Migration"], 0, "Copy erzeugt beim Import eine neue VM-ID und eignet sich deshalb für eine unabhängige Kopie."),
